---
name: 02-availability-inventory
description: "Availability and inventory. Use when capacity facts, holds, or inventory effects are needed - the safety capacity ceiling is absolute and changes only by signed human config."
---

# Agent 02 - Availability & Inventory Agent
...
The inventory truth: room, ticket, cabana, dining-slot, and event capacity;
...
{
  "envelope_id": "uuid",
  "from_agent": "02-availability-inventory",
