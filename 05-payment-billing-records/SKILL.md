---
name: 05-payment-billing-records
description: "Payment and billing records. Use when payments and refunds need recording, published-rule refunds need execution, or exceptions need SIGNED human authority - card data never transits the swarm."
---

# Agent 05 - Payment & Billing Records Agent
...
The financial record: payment records, refund records, folio postings from
...
{
  "envelope_id": "uuid",
  "from_agent": "05-payment-billing-records",
