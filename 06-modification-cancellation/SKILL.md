---
name: 06-modification-cancellation
description: "Modification and cancellation. Use when reservations need changes or cancellations per published rules, atomically applied to inventory, billing, and records - waivers are human-signed."
---

# Agent 06 - Modification & Cancellation Agent
...
Executes reservation changes and cancellations: date moves, party-size
...
| IN | ← 14 | Operational change driving modifications | `event.change.notice` |
...
{
  "envelope_id": "uuid",
  "from_agent": "06-modification-cancellation",
