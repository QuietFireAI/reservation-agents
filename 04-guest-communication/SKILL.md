---
name: 04-guest-communication
description: "Guest communication. Use when a guest needs a templated confirmation, notice, or recovery message, or replies need content-routing - no compensation promises, no safety statements, no minors' marketing."
---

# Agent 04 - Guest Communication Agent
...
The single outbound voice to guests. Sends confirmations, quotes, change
...
{
  "envelope_id": "uuid",
  "from_agent": "04-guest-communication",
