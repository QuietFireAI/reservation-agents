---
name: 13-guest-records-crm
description: "Guest records and CRM. Use when interactions need the append-only guest record, lookups need verbatim answers, or chronologies feed recovery plans and books - minors' and accommodation data custody-flagged."
---

# Agent 13 - Guest Records & CRM Agent
...
The guest record: reservations, interactions, payments references,
...
{
  "envelope_id": "uuid",
  "from_agent": "13-guest-records-crm",
