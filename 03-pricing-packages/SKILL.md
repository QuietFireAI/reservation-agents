---
name: 03-pricing-packages
description: "Pricing and packages. Use when quotes are needed from published rate tables, package rules, or group tiers - a price not in a table does not exist."
---

# Agent 03 - Pricing & Packages Agent
...
Produces quotes strictly from published rate tables, package definitions,
...
{
  "envelope_id": "uuid",
  "from_agent": "03-pricing-packages",
